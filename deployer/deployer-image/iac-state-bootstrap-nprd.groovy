pipelineJob('Infrastructure/NonProduction/iac-state-bootstrap-nprd') {
    definition {
        cps {
            sandbox(true)
            script('''
...
*/
        ...
        stage("Deploying Bootstrap Infrastructure") {
         steps {
           dir("/var/jenkins_home/workspace/Infrastructure/NonProduction/iac-state-bootstrap-nprd/minitaur/bootstrap") {
                sh './test.sh'
           }
           dir("/var/jenkins_home/workspace/Infrastructure/NonProduction/iac-state-bootstrap-nprd/minitaur/bootstrap") {
                sh './deploy.sh'
