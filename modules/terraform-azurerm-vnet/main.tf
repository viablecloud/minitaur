...
resource "azurerm_virtual_network" "vnet" {
  ...
  bgp_community = var.bgp_community //BGP community attribute in format 12076:<community-value> 
  //Microsoft uses AS 12076 for Azure public, Azure private and Microsoft peering.
...
resource "azurerm_network_security_group" "nsg" {
  for_each = { for key, value in var.subnets : key => value if(lookup(value, "nsg_inbound_rules", null) != null || lookup(value, "nsg_outbound_rules", null) != null) }
